...
```json
{
    ...
    "data": [
        {
            "SI.No": 1,
            "question": "<p>കെ.പി.ആർ. ഗോപാലനെ വധശിക്ഷയ്ക്കു വിധിക്കാൻ കാരണമായ പ്രക്ഷോഭം:</p>",
            "options": [
                "ആറ്റിങ്ങൽ കലാപം",
                "മൊറാഴ സമരം",
                "അഞ്ചുതെങ്ങ് കലാപം",
        ...
        {
            "SI.No": 2,
            "question": "<p>ചുവടെ തന്നിരിക്കുന്നവയിൽ തെറ്റായ ജോഡിയേത് :</p>",
            "options": [
                "പന്തിഭോജനം - തൈക്കാട് അയ്യ",
                "സമപന്തിഭോജനം - വൈകുണ്ഠസ്വാമികൾ",
                "പ്രീതിഭോജനം - വാഗ്ഭടാനന്ദൻ",
                "മിശ്രഭോജനം – ശ്രീനാരായണ ഗുരു"
            ],
            "correct_answer": "D",
            "type": "MCQ"
        },
        {
            "SI.No": 3,
            "question": "<p>താഴെപ്പറയുന്ന കേരള മുഖ്യമന്ത്രിമാരുടെ ശരിയായ കാലാനുക്രമം തിരഞ്ഞെടുക്കുക.</p><ul><li>(i) ഇ. എം. എസ്. നമ്പൂതിരിപ്പാട്</li><li>(ii) പട്ടം താണുപിള്ള</li><li>(iii) സി. അച്യുതമേനോൻ</li><li>(iv) ആർ. ശങ്കർ</li></ul>",
            "options": [
                "ii, i, iii, iv",
                "i, ii, iv, iii",
                "iv, i, ii, iii",
